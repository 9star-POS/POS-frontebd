...
const Calendar = ({
  ...
  return (
    <div className="text-sm">
      ...
      <button
        ref={buttonRef}
        className="bg-primary border border-gray-300 flex gap-2 items-center text-white font-semibold px-4 py-3 md:px-8 md:py-2.5 rounded-lg hover:bg-primary/80 transition-colors duration-300"
